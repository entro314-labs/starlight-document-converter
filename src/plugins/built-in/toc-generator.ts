...
export class TocGenerator {
   ...
   */
  generateTocWithCustomAnchors(
    content: string,
    anchorGenerator?: (title: string) => string
  ): TocEntry[] {
   ...
   */
  insertTocIntoContent(
    content: string,
    tocPosition: 'top' | 'after-title' | 'custom' = 'after-title',
    customMarker?: string
  ): string {
