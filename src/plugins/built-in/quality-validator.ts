import type { QualityValidator, QualityReport, QualityIssue, DocumentMetadata, ProcessingContext } from '../types.js';
...
function generateSuggestions(issues: QualityIssue[], metadata: DocumentMetadata, content: string): string[] {
